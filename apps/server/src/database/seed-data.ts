...
export const SEED_ITEMS = [
    ...
    { id: "tip-13", name: "Sango de Choclo con camaron", category: "Entradas", price: 13.95, image: "/pics/42.jpeg" },
    ...
    { id: "san-3", name: "Sándwich Vegetariano", category: "Entradas", price: 5.80 },
    { id: "nin-1", name: "Pechuga de Pollo con Papas Fritas", category: "Entradas", price: 4.50 },
    { id: "nin-2", name: "Mini Hamburguesa con Papas", category: "Entradas", price: 4.00 },
    { id: "nin-3", name: "Pizza Personal", category: "Entradas", price: 4.20 },

    // Adicionales
    { id: "adi-1", name: "Papas Fritas", category: "Adicionales", price: 2.00 },
    { id: "adi-2", name: "Arroz Blanco", category: "Adicionales", price: 1.50 },
    { id: "adi-3", name: "Ensalada Mixta", category: "Adicionales", price: 2.30 },

    // Piqueos
    { id: "piq-1", name: "Yuca con Salsa", category: "Piqueos", price: 3.80 },
    { id: "piq-2", name: "Tostones con Guacamole", category: "Piqueos", price: 4.20 },
    { id: "piq-3", name: "Alitas de Pollo", category: "Piqueos", price: 5.00 },

    // Postres (mapped from Postres, Desayuno y Tarde)
    { id: "pos-1", name: "Tarta de Manzana", category: "Postres", price: 3.00 },
    { id: "pos-2", name: "Flan Casero", category: "Postres", price: 2.80 },
    { id: "pos-3", name: "Helado de Chocolate", category: "Postres", price: 2.50, image: "/pics/8.jpeg" },
    { id: "des-1", name: "Desayuno Tradicional", category: "Postres", price: 7.00 },
    { id: "des-2", name: "Tostadas con Mantequilla", category: "Postres", price: 3.50 },
    { id: "des-3", name: "Café con Leche", category: "Postres", price: 2.50 },

    // Gaseosas (mapped from Bebidas Calientes, Gaseosas)
    { id: "cal-1", name: "Café Americano", category: "Gaseosas", price: 1.80 },
    { id: "cal-2", name: "Té Verde", category: "Gaseosas", price: 1.50 },
    { id: "cal-3", name: "Chocolate Caliente", category: "Gaseosas", price: 2.20 },
    ...
    { id: "tra-1", name: "Mojito", category: "Tragos", price: 5.50 },
    { id: "tra-2", name: "Pisco Sour", category: "Tragos", price: 6.00 },
    { id: "tra-3", name: "Caipirinha", category: "Tragos", price: 5.80 },
